...
export default function GondolasPage() {
  ...
  const handleCreateGondolaSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!newGondola.serialNumber || !newGondola.location || !newGondola.status) {
      alert("Please fill in all required fields (Serial Number, Location, and Status)");
      return;
    }
  ...
  const handleExport = async () => {
    ...
    link.setAttribute("download", `gondolas-export-${new Date().toISOString().split("T")[0]}.csv`);
      ...
      <div className="bg-background border rounded-lg overflow-hidden">
        <div className="p-4 flex flex-col sm:flex-row gap-4 border-b">
          ...
          <div className="flex gap-2">
            ...
            <Dialog open={isNewGondolaDialogOpen} onOpenChange={setIsNewGondolaDialogOpen}>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Input
            ...
            onChange={e => setNewGondola({ ...newGondola, serialNumber: e.target.value })}
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e => setNewGondola({ ...newGondola, location: e.target.value })}
          />
        </div>
        <div>
          ...
          <Input
            ...
            onChange={e => setNewGondola({ ...newGondola, locationDetail: e.target.value })}
          />
        </div>
        {/* Status */}
        <div>
          ...
          <Select
            ...
            onValueChange={value => setNewGondola({ ...newGondola, status: value })}
          >
            <SelectTrigger>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e => setNewGondola({ ...newGondola, lastInspection: e.target.value })}
          />
        </div>
        <div>
          ...
          <Input
            ...
            onChange={e => setNewGondola({ ...newGondola, nextInspection: e.target.value })}
          />
        </div>
        {/* Notes */}
        <div>
          ...
          <Textarea
            ...
            onChange={e => setNewGondola({ ...newGondola, notes: e.target.value })}
          />
        </div>
        {/* Image Upload */}
        <div>
          <Label htmlFor="gondolaImage">Gondola Image (Optional)</Label>
          <Input
            id="gondolaImage"
            type="file"
            accept="image/*"
