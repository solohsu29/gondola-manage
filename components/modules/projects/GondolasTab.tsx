...
export default function GondolasTab ({ gondolas }: { gondolas: any[] }) {
  ...
  const [isScheduleInspectionDialogOpen, setIsScheduleInspectionDialogOpen] =
    useState(false)
  const [selectedGondolaForInspection, setSelectedGondolaForInspection] =
    useState<any>(null)
  ...
  async function handleScheduleInspectionSubmit () {
    const { inspectionType, inspectionDate, inspectionTime, inspector } =
    ...
    try {
      ...
      const res = await fetch(
        `/api/gondola/${selectedGondolaForInspection?.id}/schedule-inspection`,
        {
          method: 'POST',
  ...
  async function handleShiftGondolaSubmit () {
    ...
    try {
      ...
      toast.success('Success', {
        description: 'Gondola location updated and shift recorded.',
        className: 'bg-[#14AA4d] text-white'
      })
    ...
    <Card>
      <CardContent className='p-6'>
        <h2 className='text-xl font-semibold mb-4'>
          Gondolas ({gondolas?.length || 0})
        </h2>
        <p className='text-foreground mb-4'>
          List of gondolas associated with this project
        </p>
                  ...
                  {(() => {
                    ...
                    return gondolaShifts.length > 0 ? (
                      <div className='space-y-2 mb-4'>
                        ...
                        >
                          <Link
                            href={`/gondolas/${gondola.id}?tab=shift-history`}
                          >
                            View all shifts
                          </Link>
                        </Button>
        ...
        <Dialog open={isShiftDialogOpen} onOpenChange={setIsShiftDialogOpen}>
          <DialogContent className='sm:max-w-[500px]'>
            <DialogHeader>
              ...
              <DialogDescription>
                Update the location details for {selectedGondola?.serialNumber}
              </DialogDescription>
            </DialogHeader>
            <div className='grid gap-4 py-4'>
              <div className='space-y-2'>
                ...
                <Input
                  id='currentLocation'
                  value={selectedGondola?.location || ''}
                  disabled
                  readOnly
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  required
                  value={shiftData.newLocation}
                  onChange={e =>
                    setShiftData(sd => ({ ...sd, newLocation: e.target.value }))
                  }
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  required
                  value={shiftData.newLocationDetail}
                  onChange={e =>
                    setShiftData(sd => ({
                      ...sd,
                      newLocationDetail: e.target.value
                    }))
                  }
                />
              </div>
              <div className='space-y-2'>
                ...
                <Select
                  name='shiftReason'
                  value={shiftData.shiftReason}
                  onValueChange={val =>
                    setShiftData(sd => ({ ...sd, shiftReason: val }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  onChange={e =>
                    setShiftData(sd => ({ ...sd, shiftDate: e.target.value }))
                  }
                  required
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  onChange={e =>
                    setShiftData(sd => ({ ...sd, notes: e.target.value }))
                  }
                />
              </div>
            </div>
        ...
        <Dialog
          open={isScheduleInspectionDialogOpen}
          onOpenChange={setIsScheduleInspectionDialogOpen}
        >
          <DialogContent className='sm:max-w-[500px]'>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                {selectedGondolaForInspection?.serialNumber}
              </DialogDescription>
            </DialogHeader>
            <div className='grid gap-4 py-4'>
              <div className='space-y-2'>
                ...
                <Select
                  name='inspectionType'
                  value={scheduleInspectionData.inspectionType}
                  onValueChange={val =>
                    setScheduleInspectionData(sd => ({
                      ...sd,
                      inspectionType: val
                    }))
                  }
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value='post_incident'>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  required
                  value={scheduleInspectionData.inspectionDate}
                  onChange={e =>
                    setScheduleInspectionData(sd => ({
                      ...sd,
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  type='time'
                  required
                  value={scheduleInspectionData.inspectionTime}
                  onChange={e =>
                    setScheduleInspectionData(sd => ({
                      ...sd,
              ...
              <div className='space-y-2'>
                ...
                <Select
                  name='inspector'
                  value={scheduleInspectionData.inspector}
                  onValueChange={val =>
                    setScheduleInspectionData(sd => ({ ...sd, inspector: val }))
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    <SelectItem value='john_smith'>
                      John Smith - Senior Inspector
                    </SelectItem>
                    <SelectItem value='sarah_jones'>
                      Sarah Jones - Safety Inspector
                    </SelectItem>
                    <SelectItem value='mike_chen'>
                      Mike Chen - Maintenance Inspector
                    </SelectItem>
                    <SelectItem value='lisa_wong'>
                      Lisa Wong - Compliance Inspector
                    </SelectItem>
              ...
              <div className='space-y-2'>
                ...
                <Select
                  name='priority'
                  value={scheduleInspectionData.priority}
                  onValueChange={val =>
                    setScheduleInspectionData(sd => ({ ...sd, priority: val }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  id='inspectionNotes'
                  placeholder='Any specific requirements or notes for the inspection'
                  value={scheduleInspectionData.notes}
                  onChange={e =>
                    setScheduleInspectionData(sd => ({
                      ...sd,
            ...
            <DialogFooter>
              <Button
                type='button'
                variant='outline'
                onClick={() => setIsScheduleInspectionDialogOpen(false)}
              >
                Cancel
              </Button>
              <Button
