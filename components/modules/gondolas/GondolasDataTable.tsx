...
export function GondolasDataTable ({
  ...
  const columns: ColumnDef<
    Gondola & { projectId?: string; image?: string },
    any
  >[] = [
    {
      id: 'image',
      ...
      cell: ({ row }) => (
        <img
          src={
            row.original.photoDataBase64
              ? `data:image/jpeg;base64,${row.original.photoDataBase64}`
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className='sm:max-w-[500px]'>
          ...
          <div className='py-4'>
            <div className='space-y-4'>
              ...
              <div>
                ...
                <Input
                  id='editLocationDetail'
                  value={editFields?.locationDetail || ''}
                  onChange={e =>
                    setEditFields((prev: any) => ({
                      ...prev,
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={val =>
                    setEditFields((prev: any) => ({ ...prev, status: val }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Input
                  id='editLastInspection'
                  type='date'
                  value={
                    editFields?.lastInspection
                      ? editFields.lastInspection.split('T')[0]
                      : ''
                  }
                  onChange={e =>
                    setEditFields((prev: any) => ({
              ...
              <div>
                ...
                <Input
                  id='editNextInspection'
                  type='date'
                  value={
                    editFields?.nextInspection
                      ? editFields.nextInspection.split('T')[0]
                      : ''
                  }
                  onChange={e =>
                    setEditFields((prev: any) => ({
          ...
          <DialogFooter>
            ...
            <Button type='submit' disabled={loading} onClick={onUpdateGondola}>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className='sm:max-w-[425px]'>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete gondola {(deleteData as any)?.id}?
