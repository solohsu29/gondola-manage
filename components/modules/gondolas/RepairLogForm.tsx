...
export default function RepairLogForm({ gondolaId, onClose, onSubmit }:{gondolaId:string,onClose:any,onSubmit:any}) {
    ...
    return (
      <div className="grid gap-4 py-4">
        <div className="space-y-2">
          ...
          <Select name="repairType" onValueChange={(value) => setType(value)} defaultValue="Repair">
            <SelectTrigger>
