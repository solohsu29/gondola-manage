    ...
    return (
      <Card>
        <CardContent className="p-0">
              ...
              <Dialog open={isRepairDialogOpen} onOpenChange={setIsRepairDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[500px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>Record repair work or part replacement for {gondolaId}</DialogDescription>
                  </DialogHeader>
                  <RepairLogForm
                    gondolaId={gondolaId}
          ...
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-4">Repair & Part Replacement Log</h3>
            {repairLogs.length > 0 ? (
          ...
          <Dialog open={isViewRepairDialogOpen} onOpenChange={setIsViewRepairDialogOpen}>
            <DialogContent className="sm:max-w-[600px]">
              <DialogHeader>
                <DialogTitle>Repair Log Details</DialogTitle>
                <DialogDescription>View complete repair information for {selectedRepairLog?.id}</DialogDescription>
              </DialogHeader>
              {selectedRepairLog && (
